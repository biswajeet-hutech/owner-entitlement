...
const OwnerEntitlement = () => {
  ...
  return (
    <>
      ...
      <Modal open={showDescrptionModal.show} className="description_modal" height={200} onHide={() => setShowDescrptionModal({ show: false, data: {} })} title={`Entitlement Description`}>
